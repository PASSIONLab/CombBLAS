...
SWIGINTERN PyObject *_wrap_pyDenseParVec_length(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  pyDenseParVec *arg1 = (pyDenseParVec *) 0 ;
  int result;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:pyDenseParVec_length",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_pyDenseParVec, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "pyDenseParVec_length" "', argument " "1"" of type '" "pyDenseParVec const *""'"); 
  }
  arg1 = reinterpret_cast< pyDenseParVec * >(argp1);
  result = (int)((pyDenseParVec const *)arg1)->length();
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"pyDenseParVec_length", _wrap_pyDenseParVec_length, METH_VARARGS, NULL},
