...
#SBATCH -N 8
#SBATCH -J inc-baseline-pipeline
#SBATCH -o slurm.inc-baseline-pipeline.o%j
...
BINARY=$HOME/Codes/CombBLAS/_build/Applications/Incremental/inc-baseline-pipeline
BASELINE=1
...
#echo Running incremental baseline pipeline simulation: $BINARY
