/* pznaupd.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int pznaupd_(integer *comm, integer *ido, char *bmat, 
	integer *n, char *which, integer *nev, doublereal *tol, doublecomplex 
	*resid, integer *ncv, doublecomplex *v, integer *ldv, integer *iparam,
	 integer *ipntr, doublecomplex *workd, doublecomplex *workl, integer *
	lworkl, doublereal *rwork, integer *info, ftnlen bmat_len, ftnlen 
	which_len)
{
    /* Format strings */
    static char fmt_1000[] = "(//,5x,\002==================================="
	    "==========\002,/5x,\002= Complex implicit Arnoldi update code   "
	    "   =\002,/5x,\002= Version Number: \002,\002 2.1\002,21x,\002 "
	    "=\002,/5x,\002= Version Date:   \002,\002 3/19/97\002,16x,\002 "
	    "=\002,/5x,\002=============================================\002,"
    ...
    static char fmt_1100[] = "(5x,\002Total number update iterations        "
	    ...
	    "\002,f12.6,/5x,\002Total time in p_naup2 routine              ="
    ...
    extern /* Subroutine */ int pivout_(integer *, integer *, integer *, 
	    integer *, integer *, char *, ftnlen), second_(real *), zstatn_(
	    void), pzvout_(integer *, integer *, integer *, doublecomplex *, 
	    integer *, char *, ftnlen), pznaup2_(integer *, integer *, char *,
...
/*     %------------------------------------% */
	...
	*info = 3;
    ...
    if (msglvl > 0) {
	pivout_(comm, &debug_1.logfil, &c__1, &mxiter, &debug_1.ndigit, "_na"
		"upd: Number of update iterations taken", (ftnlen)41);
	pivout_(comm, &debug_1.logfil, &c__1, &np, &debug_1.ndigit, "_naupd:"
		" Number of wanted \"converged\" Ritz values", (ftnlen)48);
	pzvout_(comm, &debug_1.logfil, &np, &workl[ritz], &debug_1.ndigit, 
		"_naupd: The final Ritz values", (ftnlen)29);
	pzvout_(comm, &debug_1.logfil, &np, &workl[bounds], &debug_1.ndigit, 
		"_naupd: Associated Ritz estimates", (ftnlen)33);
    }
