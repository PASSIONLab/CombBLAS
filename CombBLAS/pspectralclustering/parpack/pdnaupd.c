/* pdnaupd.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int pdnaupd_(integer *comm, integer *ido, char *bmat, 
	 ...
	 integer *info, ftnlen bmat_len, ftnlen which_len)
{
    ...
    extern /* Subroutine */ int pdvout_(integer *, integer *, integer *, 
	    ...
	    second_(real *), dstatn_(void), pdnaup2_(integer *, integer *, 
...
/*     %-------------------------------------------------------% */
    ...
    pdnaup2_(comm, ido, bmat, n, which, &nev0, &np, tol, &resid[1], &mode, &
...
/*     %------------------------------------% */
	...
	*info = 3;
	...
	pdvout_(comm, &debug_1.logfil, &np, &workl[ritzr], &debug_1.ndigit, 
		"_naupd: Real part of the final Ritz values", (ftnlen)42);
	pdvout_(comm, &debug_1.logfil, &np, &workl[ritzi], &debug_1.ndigit, 
