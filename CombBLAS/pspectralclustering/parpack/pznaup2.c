/* pznaup2.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int pznaup2_(integer *comm, integer *ido, char *bmat, 
	integer *n, char *which, integer *nev, integer *np, doublereal *tol, 
	doublecomplex *resid, integer *mode, integer *iupd, integer *ishift, 
	integer *mxiter, doublecomplex *v, integer *ldv, doublecomplex *h__, 
	integer *ldh, doublecomplex *ritz, doublecomplex *bounds, 
	doublecomplex *q, integer *ldq, doublecomplex *workl, integer *ipntr, 
	doublecomplex *workd, doublereal *rwork, integer *info, ftnlen 
	bmat_len, ftnlen which_len)
{
    ...
    static doublereal cmpnorm_buf__;
    static integer nev0;
    ...
    extern /* Subroutine */ int mpi_allreduce__(doublereal *, doublecomplex *,
	     integer *, integer *, integer *, integer *, integer *), zcopy_(
    ...
    extern /* Subroutine */ int pzmout_(integer *, integer *, integer *, 
	    integer *, doublecomplex *, integer *, integer *, char *, ftnlen),
	     pivout_(integer *, integer *, integer *, integer *, integer *, 
	    char *, ftnlen), second_(real *), pdvout_(integer *, integer *, 
	    integer *, doublereal *, integer *, char *, ftnlen), zsortc_(char 
	    *, logical *, integer *, doublecomplex *, doublecomplex *, ftnlen)
	    , pzvout_(integer *, integer *, integer *, doublecomplex *, 
	    integer *, char *, ftnlen), pzgetv0_(integer *, integer *, char *,
	     integer *, logical *, integer *, integer *, doublecomplex *, 
    ...
    extern /* Subroutine */ int pzneigh_(integer *, doublereal *, integer *, 
	    doublecomplex *, integer *, doublecomplex *, doublecomplex *, 
	    doublecomplex *, integer *, doublecomplex *, doublereal *, 
	    integer *);
    static doublecomplex cmpnorm;
    extern /* Subroutine */ int pznaitr_(integer *, integer *, char *, 
	    integer *, integer *, integer *, integer *, doublecomplex *, 
	    doublereal *, doublecomplex *, integer *, doublecomplex *, 
	    integer *, integer *, doublecomplex *, doublecomplex *, integer *,
	     ftnlen), pzngets_(integer *, integer *, char *, integer *, 
	    integer *, doublecomplex *, doublecomplex *, ftnlen), pznapps_(
	    integer *, integer *, integer *, integer *, doublecomplex *, 
	    doublecomplex *, integer *, doublecomplex *, integer *, 
...
/* L10: */
    ...
    if (getv0) {
	pzgetv0_(comm, ido, bmat, &c__1, &initv, n, &c__1, &v[v_offset], ldv, 
...
/*     %----------------------------------------------------------% */
    ...
    pznaitr_(comm, ido, bmat, n, &c__0, nev, mode, &resid[1], &rnorm, &v[
...
L20:
    ...
    pznaitr_(comm, ido, bmat, n, nev, np, mode, &resid[1], &rnorm, &v[
	    v_offset], ldv, &h__[h_offset], ldh, &ipntr[1], &workd[1], &workl[
	    1], info, (ftnlen)1);
...
/*        %--------------------------------------------------------% */
    ...
    pzneigh_(comm, &rnorm, &kplusp, &h__[h_offset], ldh, &ritz[1], &bounds[1],
...
/*        %---------------------------------------------------% */
    ...
    pzngets_(comm, ishift, which, nev, np, &ritz[1], &bounds[1], (ftnlen)2);
...
/* L25: */
	...
	pzvout_(comm, &debug_1.logfil, &kplusp, &ritz[1], &debug_1.ndigit, 
		"_naup2: The eigenvalues of H", (ftnlen)28);
	pzvout_(comm, &debug_1.logfil, &kplusp, &bounds[1], &debug_1.ndigit, 
...
/* Computing 2nd power */
	    i__1 = kplusp;
	    pzvout_(comm, &debug_1.logfil, &kplusp, &workl[i__1 * i__1 + 1], &
		    debug_1.ndigit, "_naup2: Eigenvalues computed by _neigh:",
		     (ftnlen)39);
/* Computing 2nd power */
	    i__1 = kplusp;
	    pzvout_(comm, &debug_1.logfil, &kplusp, &workl[i__1 * i__1 + 
...
/*           %-----------------------------------------------% */
	...
	if (msglvl > 1) {
	    ...
	    pzvout_(comm, &debug_1.logfil, &kplusp, &bounds[1], &
...
/*           %---------------------------------------% */
	...
	if (nevbef < *nev) {
	    pzngets_(comm, ishift, which, nev, np, &ritz[1], &bounds[1], (
		    ftnlen)2);
	}
	...
	if (msglvl > 1) {
	    ...
	    pzvout_(comm, &debug_1.logfil, nev, &ritz[*np + 1], &
		    debug_1.ndigit, "_naup2: \"wanted\" Ritz values ", (
		    ftnlen)29);
	    pzvout_(comm, &debug_1.logfil, nev, &bounds[*np + 1], &
...
/*            %----------------------------------% */
	...
	pzvout_(comm, &debug_1.logfil, np, &ritz[1], &debug_1.ndigit, "_naup"
		"2: values of the shifts", (ftnlen)28);
	if (*ishift == 1) {
	    pzvout_(comm, &debug_1.logfil, np, &bounds[1], &debug_1.ndigit, 
...
/*        %---------------------------------------------------------% */
    ...
    pznapps_(comm, n, nev, np, &ritz[1], &v[v_offset], ldv, &h__[h_offset], 
...
/*        %----------------------------------% */
	...
	pdvout_(comm, &debug_1.logfil, &c__1, &rnorm, &debug_1.ndigit, "_nau"
		...
		55);
	pzmout_(comm, &debug_1.logfil, nev, nev, &h__[h_offset], ldh, &
