/* pdneigh.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int pdneigh_(integer *comm, doublereal *rnorm, integer *n, 
	doublereal *h__, integer *ldh, doublereal *ritzr, doublereal *ritzi, 
	doublereal *bounds, doublereal *q, integer *ldq, doublereal *workl, 
	integer *ierr)
{
...
/*     %-------------------------------% */
    ...
    if (msglvl > 2) {
	pdmout_(comm, &debug_1.logfil, n, n, &h__[h_offset], ldh, &
...
/*     %-----------------------------------------------------------% */
    ...
    if (msglvl > 1) {
	pdvout_(comm, &debug_1.logfil, n, &bounds[1], &debug_1.ndigit, "_nei"
...
/* L10: */
    ...
    if (msglvl > 1) {
	pdvout_(comm, &debug_1.logfil, n, &workl[1], &debug_1.ndigit, "_neig"
...
/* L20: */
    ...
    if (msglvl > 2) {
	pdvout_(comm, &debug_1.logfil, n, &ritzr[1], &debug_1.ndigit, "_neig"
		"h: Real part of the eigenvalues of H", (ftnlen)41);
	pdvout_(comm, &debug_1.logfil, n, &ritzi[1], &debug_1.ndigit, "_neig"
