/* pcmout.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int pcmout_(integer *comm, integer *lout, integer *m, 
	integer *n, complex *a, integer *lda, integer *idigit, char *ifmt, 
	ftnlen ifmt_len)
{
    /* Initialized data */
