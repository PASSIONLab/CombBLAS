/* pcngets.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int pcngets_(integer *comm, integer *ishift, char *which, 
	integer *kev, integer *np, complex *ritz, complex *bounds, ftnlen 
	which_len)
{
    ...
    extern /* Subroutine */ int pcvout_(integer *, integer *, integer *, 
	    complex *, integer *, char *, ftnlen), csortc_(char *, logical *, 
	    integer *, complex *, complex *, ftnlen), pivout_(integer *, 
...
/*        %-------------------------------------------------------% */
    ...
    if (msglvl > 0) {
	pivout_(comm, &debug_1.logfil, &c__1, kev, &debug_1.ndigit, "_ngets:"
		" KEV is", (ftnlen)14);
	pivout_(comm, &debug_1.logfil, &c__1, np, &debug_1.ndigit, "_ngets: "
		"NP is", (ftnlen)13);
	i__1 = *kev + *np;
	pcvout_(comm, &debug_1.logfil, &i__1, &ritz[1], &debug_1.ndigit, 
		"_ngets: Eigenvalues of current H matrix ", (ftnlen)40);
	i__1 = *kev + *np;
	pcvout_(comm, &debug_1.logfil, &i__1, &bounds[1], &debug_1.ndigit, 
