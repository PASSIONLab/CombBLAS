/* pcgetv0.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int pcgetv0_(integer *comm, integer *ido, char *bmat, 
	integer *itry, logical *initv, integer *n, integer *j, complex *v, 
	integer *ldv, complex *resid, real *rnorm, integer *ipntr, complex *
	workd, complex *workl, integer *ierr, ftnlen bmat_len)
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int mpi_allreduce__(complex *, complex *, integer 
	    *, integer *, integer *, integer *, integer *), mpi_comm_rank__(
	    integer *, integer *, integer *);
    static complex cnorm2;
    extern doublereal slapy2_(real *, real *);
    static real rnorm0;
    static integer msglvl;
    extern /* Subroutine */ int pcvout_(integer *, integer *, integer *, 
	    complex *, integer *, char *, ftnlen), second_(real *), psvout_(
	    integer *, integer *, integer *, real *, integer *, char *, 
	    ftnlen), pclarnv_(integer *, integer *, integer *, integer *, 
	    complex *);
...
/*        %-----------------------------------------------------% */
	...
	if (! (*initv)) {
	    idist = 2;
	    pclarnv_(comm, &idist, iseed, n, &resid[1]);
	}
...
L20:
	...
	rnorm0 = pscnorm2_(comm, n, &resid[1], &c__1);
    }
    *rnorm = rnorm0;
...
L30:
    ...
    cgemv_("N", n, &i__1, &q__1, &v[v_offset], ldv, &workl[1], &c__1, &c_b1, &
...
L50:
	...
	cnorm2.r = q__1.r, cnorm2.i = q__1.i;
	pcvout_(comm, &debug_1.logfil, &c__1, &cnorm2, &debug_1.ndigit, "_ge"
		"tv0: B-norm of initial / restarted starting vector", (ftnlen)
		53);
    }
    if (msglvl > 2) {
	pcvout_(comm, &debug_1.logfil, n, &resid[1], &debug_1.ndigit, "_getv"
