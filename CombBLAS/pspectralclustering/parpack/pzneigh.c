/* pzneigh.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int pzneigh_(integer *comm, doublereal *rnorm, integer *n, 
	doublecomplex *h__, integer *ldh, doublecomplex *ritz, doublecomplex *
	bounds, doublecomplex *q, integer *ldq, doublecomplex *workl, 
	doublereal *rwork, integer *ierr)
{
    ...
    extern /* Subroutine */ int zlacpy_(char *, integer *, integer *, 
	    ...
	    doublecomplex *, integer *, doublecomplex *, integer *, integer *,
	     doublecomplex *, integer *, integer *), zdscal_(integer *, 
	    doublereal *, doublecomplex *, integer *), ztrevc_(char *, char *,
	     logical *, integer *, doublecomplex *, integer *, doublecomplex *
	    , integer *, doublecomplex *, integer *, integer *, integer *, 
	    doublecomplex *, doublereal *, integer *, ftnlen, ftnlen), 
	    zlaset_(char *, integer *, integer *, doublecomplex *, 
	    doublecomplex *, doublecomplex *, integer *, ftnlen), pzmout_(
	    integer *, integer *, integer *, integer *, doublecomplex *, 
	    integer *, integer *, char *, ftnlen), pzvout_(integer *, integer 
...
/*     %-------------------------------% */
    ...
    if (msglvl > 2) {
	pzmout_(comm, &debug_1.logfil, n, n, &h__[h_offset], ldh, &
		debug_1.ndigit, "_neigh: Entering upper Hessenberg matrix H ",
		 (ftnlen)43);
    }
...
/*     %----------------------------------------------------------% */
    ...
    zlaset_("All", n, n, &c_b7, &c_b8, &q[q_offset], ldq, (ftnlen)3);
    ...
    if (msglvl > 1) {
	pzvout_(comm, &debug_1.logfil, n, &bounds[1], &debug_1.ndigit, "_nei"
		"gh: last row of the Schur matrix for H", (ftnlen)42);
    }
...
/* L10: */
	...
	pzvout_(comm, &debug_1.logfil, n, &workl[1], &debug_1.ndigit, "_neig"
		"h: Last row of the eigenvector matrix for H", (ftnlen)48);
    }
...
/*     %----------------------------% */
    ...
    if (msglvl > 2) {
	pzvout_(comm, &debug_1.logfil, n, &ritz[1], &debug_1.ndigit, "_neigh"
		": The eigenvalues of H", (ftnlen)28);
	pzvout_(comm, &debug_1.logfil, n, &bounds[1], &debug_1.ndigit, "_nei"
		"gh: Ritz estimates for the eigenvalues of H", (ftnlen)47);
    }
