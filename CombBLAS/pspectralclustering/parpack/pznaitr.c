/* pznaitr.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int pznaitr_(integer *comm, integer *ido, char *bmat, 
	integer *n, integer *k, integer *np, integer *nb, doublecomplex *
	resid, doublereal *rnorm, doublecomplex *v, integer *ldv, 
	doublecomplex *h__, integer *ldh, integer *ipntr, doublecomplex *
	workd, doublecomplex *workl, integer *info, ftnlen bmat_len)
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int mpi_allreduce__(doublecomplex *, 
	    doublecomplex *, integer *, integer *, integer *, integer *, 
	    integer *), zcopy_(integer *, doublecomplex *, integer *, 
    ...
    extern /* Subroutine */ int zdscal_(integer *, doublereal *, 
	    doublecomplex *, integer *), pivout_(integer *, integer *, 
	    integer *, integer *, integer *, char *, ftnlen), second_(real *);
    extern doublereal zlanhs_(char *, integer *, doublecomplex *, integer *, 
	    doublecomplex *, ftnlen);
    extern /* Subroutine */ int zlascl_(char *, integer *, integer *, 
	    doublereal *, doublereal *, integer *, integer *, doublecomplex *,
	     integer *, integer *, ftnlen), pzmout_(integer *, integer *, 
	    integer *, integer *, doublecomplex *, integer *, integer *, char 
	    *, ftnlen), pdvout_(integer *, integer *, integer *, doublereal *,
	     integer *, char *, ftnlen), pzvout_(), pzgetv0_(integer *, 
...
L1000:
	...
	pzvout_(comm, &debug_1.logfil, &c__1, rnorm, &debug_1.ndigit, "_nait"
...
/*           %--------------------------------------% */
    ...
    pzgetv0_(comm, ido, bmat, &itry, &c_false, n, &j, &v[v_offset], ldv, &
...
/*            %-----------------------------------------% */
	...
	zlascl_("General", &i__, &i__, rnorm, &c_b28, n, &c__1, &v[j * v_dim1 
		+ 1], n, &infol, (ftnlen)7);
	zlascl_("General", &i__, &i__, rnorm, &c_b28, n, &c__1, &workd[ipj], 
		n, &infol, (ftnlen)7);
    }
...
/*        %-------------------------------------% */
	...
	wnorm = pdznorm2_(comm, n, &resid[1], &c__1);
    }
...
/*        %------------------------------------------% */
    ...
    zgemv_("C", n, &j, &c_b5, &v[v_offset], ldv, &workd[ipj], &c__1, &c_b51, &
...
/*        %--------------------------------------% */
    ...
    zgemv_("N", n, &j, &c_b54, &v[v_offset], ldv, &h__[j * h_dim1 + 1], &c__1,
	     &c_b5, &resid[1], &c__1, (ftnlen)1);
...
L80:
	...
	rtemp[0] = wnorm;
	rtemp[1] = *rnorm;
	pdvout_(comm, &debug_1.logfil, &c__2, rtemp, &debug_1.ndigit, "_nait"
		"r: re-orthogonalization; wnorm and rnorm are", (ftnlen)49);
	pzvout_(comm, &debug_1.logfil, &j, &h__[j * h_dim1 + 1], &
...
/*        %---------------------------------------------% */
    ...
    zgemv_("N", n, &j, &c_b54, &v[v_offset], ldv, &workl[1], &c__1, &c_b5, &
	    resid[1], &c__1, (ftnlen)1);
    zaxpy_(&j, &c_b5, &workl[1], &c__1, &h__[j * h_dim1 + 1], &c__1);
...
/*        %-----------------------------------------------------% */
	...
	rnorm1 = pdznorm2_(comm, n, &resid[1], &c__1);
    }
	...
	if (msglvl > 2) {
	    rtemp[0] = *rnorm;
	    rtemp[1] = rnorm1;
	    pdvout_(comm, &debug_1.logfil, &c__2, rtemp, &debug_1.ndigit, 
...
/* L110: */
	...
	if (msglvl > 2) {
	    i__1 = *k + *np;
	    i__2 = *k + *np;
	    pzmout_(comm, &debug_1.logfil, &i__1, &i__2, &h__[h_offset], ldh, 
