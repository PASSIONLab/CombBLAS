/* psnaup2.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int psnaup2_(integer *comm, integer *ido, char *bmat, 
	integer *n, char *which, integer *nev, integer *np, real *tol, real *
	resid, integer *mode, integer *iupd, integer *ishift, integer *mxiter,
	 real *v, integer *ldv, real *h__, integer *ldh, real *ritzr, real *
	ritzi, real *bounds, real *q, integer *ldq, real *workl, integer *
	ipntr, real *workd, integer *info, ftnlen bmat_len, ftnlen which_len)
{
    ...
    extern /* Subroutine */ int scopy_(integer *, real *, integer *, real *, 
	    ...
	    integer *, integer *, integer *), svout_(integer *, integer *, 
    ...
    extern /* Subroutine */ int snconv_(integer *, real *, real *, real *, 
	    real *, integer *), psvout_(integer *, integer *, integer *, real 
	    *, integer *, char *, ftnlen), pivout_(integer *, integer *, 
	    integer *, integer *, integer *, char *, ftnlen), second_(real *),
	     ssortc_(char *, logical *, integer *, real *, real *, real *, 
	    ftnlen), psmout_(integer *, integer *, integer *, integer *, real 
	    *, integer *, integer *, char *, ftnlen), psgetv0_(integer *, 
    ...
    extern /* Subroutine */ int psneigh_(integer *, real *, integer *, real *,
	     integer *, real *, real *, real *, real *, integer *, real *, 
	    integer *), psnaitr_(integer *, integer *, char *, integer *, 
	    integer *, integer *, integer *, real *, real *, real *, integer *
	    , real *, integer *, integer *, real *, real *, integer *, ftnlen)
	    , psngets_(integer *, integer *, char *, integer *, integer *, 
	    real *, real *, real *, real *, real *, ftnlen), psnapps_(integer 
...
/*     %----------------------------------------------------------% */
    ...
    psnaitr_(comm, ido, bmat, n, &c__0, nev, mode, &resid[1], &rnorm, &v[
...
L20:
    ...
    psnaitr_(comm, ido, bmat, n, nev, np, mode, &resid[1], &rnorm, &v[
	    v_offset], ldv, &h__[h_offset], ldh, &ipntr[1], &workd[1], &workl[
	    1], info, (ftnlen)1);
...
/*        %--------------------------------------------------------% */
    ...
    psneigh_(comm, &rnorm, &kplusp, &h__[h_offset], ldh, &ritzr[1], &ritzi[1],
...
/*        %---------------------------------------------------% */
    ...
    *np = np0;
    numcnv = *nev;
    psngets_(comm, ishift, which, nev, np, &ritzr[1], &ritzi[1], &bounds[1], &
...
/*        %-------------------% */
	...
	psvout_(comm, &debug_1.logfil, &kplusp, &ritzr[1], &debug_1.ndigit, 
		"_naup2: Real part of the eigenvalues of H", (ftnlen)41);
	psvout_(comm, &debug_1.logfil, &kplusp, &ritzi[1], &debug_1.ndigit, 
...
/*           %---------------------------------------% */
	...
	if (nevbef < *nev) {
	    psngets_(comm, ishift, which, nev, np, &ritzr[1], &ritzi[1], &
	...
	if (msglvl > 1) {
	    ...
	    psvout_(comm, &debug_1.logfil, nev, &ritzr[*np + 1], &
		    debug_1.ndigit, "_naup2: \"wanted\" Ritz values -- real "
		    "part", (ftnlen)41);
	    psvout_(comm, &debug_1.logfil, nev, &ritzi[*np + 1], &
...
/*            %----------------------------------% */
	...
	psvout_(comm, &debug_1.logfil, np, &ritzr[1], &debug_1.ndigit, "_nau"
		"p2: Real part of the shifts", (ftnlen)31);
	psvout_(comm, &debug_1.logfil, np, &ritzi[1], &debug_1.ndigit, "_nau"
...
/*        %---------------------------------------------------------% */
    ...
    psnapps_(comm, n, nev, np, &ritzr[1], &ritzi[1], &v[v_offset], ldv, &h__[
...
/*        %----------------------------------% */
	...
	psvout_(comm, &debug_1.logfil, &c__1, &rnorm, &debug_1.ndigit, "_nau"
		...
		55);
	psmout_(comm, &debug_1.logfil, nev, nev, &h__[h_offset], ldh, &
