/* pdngets.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int pdngets_(integer *comm, integer *ishift, char *which, 
	integer *kev, integer *np, doublereal *ritzr, doublereal *ritzi, 
	doublereal *bounds, doublereal *shiftr, doublereal *shifti, ftnlen 
	which_len)
{
    ...
    extern /* Subroutine */ int dsortc_(char *, logical *, integer *, 
	    doublereal *, doublereal *, doublereal *, ftnlen), pivout_(
...
/*        %-------------------------------------------------------% */
	...
	pivout_(comm, &debug_1.logfil, &c__1, np, &debug_1.ndigit, "_ngets: "
		"NP is", (ftnlen)13);
	i__1 = *kev + *np;
	pdvout_(comm, &debug_1.logfil, &i__1, &ritzr[1], &debug_1.ndigit, 
		"_ngets: Eigenvalues of current H matrix -- real part", (
		ftnlen)52);
	i__1 = *kev + *np;
	pdvout_(comm, &debug_1.logfil, &i__1, &ritzi[1], &debug_1.ndigit, 
