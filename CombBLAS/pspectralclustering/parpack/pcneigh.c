/* pcneigh.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int pcneigh_(integer *comm, real *rnorm, integer *n, complex 
	*h__, integer *ldh, complex *ritz, complex *bounds, complex *q, 
	integer *ldq, complex *workl, real *rwork, integer *ierr)
{
    ...
    extern /* Subroutine */ int ctrevc_(char *, char *, logical *, integer *, 
	    ...
	    ftnlen), pcmout_(integer *, integer *, integer *, integer *, 
	    complex *, integer *, integer *, char *, ftnlen), pcvout_(integer 
	    *, integer *, integer *, complex *, integer *, char *, ftnlen), 
	    second_(real *), claset_(char *, integer *, integer *, complex *, 
...
/*     %-------------------------------% */
    ...
    if (msglvl > 2) {
	pcmout_(comm, &debug_1.logfil, n, n, &h__[h_offset], ldh, &
...
/*     %----------------------------------------------------------% */
    ...
    if (msglvl > 1) {
	pcvout_(comm, &debug_1.logfil, n, &bounds[1], &debug_1.ndigit, "_nei"
...
/* L10: */
	...
	pcvout_(comm, &debug_1.logfil, n, &workl[1], &debug_1.ndigit, "_neig"
...
/*     %----------------------------% */
    ...
    if (msglvl > 2) {
	pcvout_(comm, &debug_1.logfil, n, &ritz[1], &debug_1.ndigit, "_neigh"
