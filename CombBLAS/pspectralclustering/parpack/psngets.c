/* psngets.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int psngets_(integer *comm, integer *ishift, char *which, 
	integer *kev, integer *np, real *ritzr, real *ritzi, real *bounds, 
	real *shiftr, real *shifti, ftnlen which_len)
{
    ...
    extern /* Subroutine */ int ssortc_(char *, logical *, integer *, real *, 
	    real *, real *, ftnlen), pivout_(integer *, integer *, integer *, 
	    integer *, integer *, char *, ftnlen), psvout_(integer *, integer 
...
/*        %-------------------------------------------------------% */
	...
	pivout_(comm, &debug_1.logfil, &c__1, np, &debug_1.ndigit, "_ngets: "
		"NP is", (ftnlen)13);
	i__1 = *kev + *np;
	psvout_(comm, &debug_1.logfil, &i__1, &ritzr[1], &debug_1.ndigit, 
		"_ngets: Eigenvalues of current H matrix -- real part", (
		ftnlen)52);
	i__1 = *kev + *np;
	psvout_(comm, &debug_1.logfil, &i__1, &ritzi[1], &debug_1.ndigit, 
