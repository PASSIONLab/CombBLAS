/* pcnaupd.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int pcnaupd_(integer *comm, integer *ido, char *bmat, 
	integer *n, char *which, integer *nev, real *tol, complex *resid, 
	integer *ncv, complex *v, integer *ldv, integer *iparam, integer *
	ipntr, complex *workd, complex *workl, integer *lworkl, real *rwork, 
	integer *info, ftnlen bmat_len, ftnlen which_len)
{
    ...
    extern /* Subroutine */ int pcvout_(integer *, integer *, integer *, 
	    complex *, integer *, char *, ftnlen), pivout_(integer *, integer 
	    *, integer *, integer *, integer *, char *, ftnlen), second_(real 
	    *), cstatn_(void), pcnaup2_(integer *, integer *, char *, integer 
...
/*     %-------------------------------------------------------% */
    ...
    pcnaup2_(comm, ido, bmat, n, which, &nev0, &np, tol, &resid[1], &mode, &
...
/*     %------------------------------------% */
	...
	*info = 3;
	...
	pcvout_(comm, &debug_1.logfil, &np, &workl[ritz], &debug_1.ndigit, 
		"_naupd: The final Ritz values", (ftnlen)29);
	pcvout_(comm, &debug_1.logfil, &np, &workl[bounds], &debug_1.ndigit, 
