/* psnaupd.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int psnaupd_(integer *comm, integer *ido, char *bmat, 
	...
	bmat_len, ftnlen which_len)
{
    ...
    static char fmt_1000[] = "(//,5x,\002==================================="
	    ...
	    "de =\002,/5x,\002= Version Number: \002,\002 2.1\002,21x,\002 "
    ...
    extern /* Subroutine */ int mpi_comm_rank__(integer *, integer *, integer 
	    *);
    static integer ritzr, bounds, ishift, msglvl, mxiter;
    extern /* Subroutine */ int pivout_(integer *, integer *, integer *, 
	    integer *, integer *, char *, ftnlen), second_(real *), sstatn_(
	    void), psvout_(integer *, integer *, integer *, real *, integer *,
	     char *, ftnlen), psnaup2_(integer *, integer *, char *, integer *
...
/*     %-------------------------------------------------------% */
    ...
    psnaup2_(comm, ido, bmat, n, which, &nev0, &np, tol, &resid[1], &mode, &
	    iupd, &ishift, &mxiter, &v[v_offset], ldv, &workl[ih], &ldh, &
	    workl[ritzr], &workl[ritzi], &workl[bounds], &workl[iq], &ldq, &
	    workl[iw], &ipntr[1], &workd[1], info, (ftnlen)1, (ftnlen)2);
...
/*     %------------------------------------% */
	...
	*info = 3;
	...
	psvout_(comm, &debug_1.logfil, &np, &workl[ritzr], &debug_1.ndigit, 
		"_naupd: Real part of the final Ritz values", (ftnlen)42);
	psvout_(comm, &debug_1.logfil, &np, &workl[ritzi], &debug_1.ndigit, 
		"_naupd: Imaginary part of the final Ritz values", (ftnlen)47)
		;
