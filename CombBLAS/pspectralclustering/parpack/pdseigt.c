/* pdseigt.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int pdseigt_(integer *comm, doublereal *rnorm, integer *n, 
	doublereal *h__, integer *ldh, doublereal *eig, doublereal *bounds, 
	doublereal *workl, integer *ierr)
{
...
/*     %-------------------------------% */
    ...
    if (msglvl > 0) {
	pdvout_(comm, &debug_1.logfil, n, &h__[(h_dim1 << 1) + 1], &
    ...
    if (msglvl > 1) {
	pdvout_(comm, &debug_1.logfil, n, &bounds[1], &debug_1.ndigit, "_sei"
