/* pcvout.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int pcvout_(integer *comm, integer *lout, integer *n, 
	complex *cx, integer *idigit, char *ifmt, ftnlen ifmt_len)
{
    /* Format strings */
