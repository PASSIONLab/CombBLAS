/* pzngets.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int pzngets_(integer *comm, integer *ishift, char *which, 
	integer *kev, integer *np, doublecomplex *ritz, doublecomplex *bounds,
	 ftnlen which_len)
{
    ...
    extern /* Subroutine */ int zsortc_(char *, logical *, integer *, 
	    doublecomplex *, doublecomplex *, ftnlen), pivout_(integer *, 
	    integer *, integer *, integer *, integer *, char *, ftnlen), 
	    pzvout_(integer *, integer *, integer *, doublecomplex *, integer 
	    *, char *, ftnlen);
...
/*        %-------------------------------------------------------% */
	...
	pivout_(comm, &debug_1.logfil, &c__1, np, &debug_1.ndigit, "_ngets: "
		"NP is", (ftnlen)13);
	i__1 = *kev + *np;
	pzvout_(comm, &debug_1.logfil, &i__1, &ritz[1], &debug_1.ndigit, 
		"_ngets: Eigenvalues of current H matrix ", (ftnlen)40);
	i__1 = *kev + *np;
	pzvout_(comm, &debug_1.logfil, &i__1, &bounds[1], &debug_1.ndigit, 
