/* psnapps.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int psnapps_(integer *comm, integer *n, integer *kev, 
	integer *np, real *shiftr, real *shifti, real *v, integer *ldv, real *
	h__, integer *ldh, real *resid, real *q, integer *ldq, real *workl, 
	real *workd)
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int slacpy_(char *, integer *, integer *, real *, 
	    ...
	    real *, integer *, real *), slartg_(real *, real *, real *, real *
	    , real *), slaset_(char *, integer *, integer *, real *, real *, 
	    real *, integer *, ftnlen), pivout_(integer *, integer *, integer 
	    *, integer *, integer *, char *, ftnlen), psmout_(integer *, 
	    integer *, integer *, integer *, real *, integer *, integer *, 
	    char *, ftnlen), psvout_(integer *, integer *, integer *, real *, 
	    integer *, char *, ftnlen);
    extern doublereal slanhs_(char *, integer *, real *, integer *, real *, 
	    ftnlen), pslamch_(integer *, char *, ftnlen);
...
/*     %----------------------------------------------% */
	...
	if (msglvl > 2) {
	    ...
	    psvout_(comm, &debug_1.logfil, &c__1, &sigmar, &debug_1.ndigit, 
		    "_napps: The real part of the shift ", (ftnlen)35);
	    psvout_(comm, &debug_1.logfil, &c__1, &sigmai, &debug_1.ndigit, 
...
/* Computing MAX */
		...
		if (msglvl > 0) {
		    ...
		    psvout_(comm, &debug_1.logfil, &c__1, &h__[i__ + 1 + i__ *
...
/*     %---------------------------------------% */
    ...
    if (msglvl > 1) {
	psvout_(comm, &debug_1.logfil, &c__1, &q[kplusp + *kev * q_dim1], &
		debug_1.ndigit, "_napps: sigmak = (e_{kev+p}^T*Q)*e_{kev}", (
		ftnlen)40);
	psvout_(comm, &debug_1.logfil, &c__1, &h__[*kev + 1 + *kev * h_dim1], 
	...
	if (msglvl > 2) {
	    psmout_(comm, &debug_1.logfil, kev, kev, &h__[h_offset], ldh, &
