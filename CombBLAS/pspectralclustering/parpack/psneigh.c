/* psneigh.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int psneigh_(integer *comm, real *rnorm, integer *n, real *
	h__, integer *ldh, real *ritzr, real *ritzi, real *bounds, real *q, 
	integer *ldq, real *workl, integer *ierr)
{
    ...
    extern /* Subroutine */ int slacpy_(char *, integer *, integer *, real *, 
	    ...
	    *, integer *, integer *, real *, integer *, real *, real *, real *
	    ...
	    integer *, real *, integer *, ftnlen, ftnlen), psmout_(integer *, 
	    integer *, integer *, integer *, real *, integer *, integer *, 
	    char *, ftnlen), psvout_(integer *, integer *, integer *, real *, 
	    integer *, char *, ftnlen);
...
/*     %-------------------------------% */
    ...
    if (msglvl > 2) {
	psmout_(comm, &debug_1.logfil, n, n, &h__[h_offset], ldh, &
...
/*     %-----------------------------------------------------------% */
    ...
    if (msglvl > 1) {
	psvout_(comm, &debug_1.logfil, n, &bounds[1], &debug_1.ndigit, "_nei"
...
/* L10: */
    ...
    if (msglvl > 1) {
	psvout_(comm, &debug_1.logfil, n, &workl[1], &debug_1.ndigit, "_neig"
...
/* L20: */
    ...
    if (msglvl > 2) {
	psvout_(comm, &debug_1.logfil, n, &ritzr[1], &debug_1.ndigit, "_neig"
		"h: Real part of the eigenvalues of H", (ftnlen)41);
	psvout_(comm, &debug_1.logfil, n, &ritzi[1], &debug_1.ndigit, "_neig"
		"h: Imaginary part of the eigenvalues of H", (ftnlen)46);
	psvout_(comm, &debug_1.logfil, n, &bounds[1], &debug_1.ndigit, "_nei"
