/* pslamch.f -- translated by f2c (version 20050501).
...
doublereal pslamch_(integer *ictxt, char *cmach, ftnlen cmach_len)
{
    /* System generated locals */
    real ret_val;

    /* Local variables */
    static real temp, temp1;
...
/*     .. Executable Statements .. */
	...
	mpi_allreduce__(&temp1, &temp, &c__1, &mpipriv_1.mpi_real__, &
		mpipriv_1.mpi_max__, ictxt, &idumm);
/*         CALL SGAMX2D( ICTXT, 'All', ' ', 1, 1, TEMP, 1, IDUMM, */
/*     $                 IDUMM, 1, -1, IDUMM ) */
    } else if (lsame_(cmach, "L", (ftnlen)1, (ftnlen)1) || lsame_(cmach, 
	    "O", (ftnlen)1, (ftnlen)1)) {
	mpi_allreduce__(&temp1, &temp, &c__1, &mpipriv_1.mpi_real__, &
		mpipriv_1.mpi_min__, ictxt, &idumm);
