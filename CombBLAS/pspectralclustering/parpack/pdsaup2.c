/* pdsaup2.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int pdsaup2_(integer *comm, integer *ido, char *bmat, 
	...
	integer *ldh, doublereal *ritz, doublereal *bounds, doublereal *q, 
	integer *ldq, doublereal *workl, integer *ipntr, doublereal *workd, 
	integer *info, ftnlen bmat_len, ftnlen which_len)
{
    ...
    extern /* Subroutine */ int dsconv_(integer *, doublereal *, doublereal *,
	     doublereal *, integer *), dsortr_(char *, logical *, integer *, 
	    doublereal *, doublereal *, ftnlen), pdvout_(integer *, integer *,
	     integer *, doublereal *, integer *, char *, ftnlen), pivout_(
	    integer *, integer *, integer *, integer *, integer *, char *, 
	    ftnlen), second_(real *), pdgetv0_(integer *, integer *, char *, 
	    integer *, logical *, integer *, integer *, doublereal *, integer 
	    *, doublereal *, doublereal *, integer *, doublereal *, 
	    doublereal *, integer *, ftnlen);
    extern doublereal pdnorm2_(integer *, integer *, doublereal *, integer *),
	     pdlamch_(integer *, char *, ftnlen);
    extern /* Subroutine */ int pdseigt_(integer *, doublereal *, integer *, 
	    doublereal *, integer *, doublereal *, doublereal *, doublereal *,
	     integer *), pdsaitr_(integer *, integer *, char *, integer *, 
	    integer *, integer *, integer *, doublereal *, doublereal *, 
	    doublereal *, integer *, doublereal *, integer *, integer *, 
	    doublereal *, doublereal *, integer *, ftnlen), pdsgets_(integer *
	    , integer *, char *, integer *, integer *, doublereal *, 
	    doublereal *, doublereal *, ftnlen), pdsapps_(integer *, integer *
...
/*     %----------------------------------------------------------% */
    ...
    pdsaitr_(comm, ido, bmat, n, &c__0, &nev0, mode, &resid[1], &rnorm, &v[
...
L20:
    ...
    pdsaitr_(comm, ido, bmat, n, nev, np, mode, &resid[1], &rnorm, &v[
	    v_offset], ldv, &h__[h_offset], ldh, &ipntr[1], &workd[1], &workl[
	    1], info, (ftnlen)1);
...
/*           %-----------------------------------------------------% */
	...
	*info = -9999;
    ...
    if (msglvl > 1) {
	pdvout_(comm, &debug_1.logfil, &c__1, &rnorm, &debug_1.ndigit, "_sau"
...
/*        %--------------------------------------------------------% */
    ...
    pdseigt_(comm, &rnorm, &kplusp, &h__[h_offset], ldh, &ritz[1], &bounds[1],
	     &workl[1], &ierr);
...
/*        %---------------------------------------------------% */
    ...
    *nev = nev0;
    *np = np0;
    pdsgets_(comm, ishift, which, nev, np, &ritz[1], &bounds[1], &workl[1], (
	    ftnlen)2);
...
/*        %-------------------% */
	...
	pdvout_(comm, &debug_1.logfil, &kplusp, &ritz[1], &debug_1.ndigit, 
...
/*           %------------------------------------------% */
	...
	if (msglvl > 1) {
	    ...
	    pdvout_(comm, &debug_1.logfil, &kplusp, &bounds[1], &
...
/*           %---------------------------------------% */
	...
	if (nevbef < *nev) {
	    pdsgets_(comm, ishift, which, nev, np, &ritz[1], &bounds[1], &
		    workl[1], (ftnlen)2);
	}
	...
	if (msglvl > 1) {
	    ...
	    pdvout_(comm, &debug_1.logfil, nev, &ritz[*np + 1], &
...
/*        %---------------------------------------------------------% */
	...
	pdvout_(comm, &debug_1.logfil, np, &workl[1], &debug_1.ndigit, "_sau"
...
/*        %---------------------------------------------------------% */
    ...
    pdsapps_(comm, n, nev, np, &ritz[1], &v[v_offset], ldv, &h__[h_offset], 
...
/* L130: */
	...
	pdvout_(comm, &debug_1.logfil, nev, &h__[(h_dim1 << 1) + 1], &
