...
class DiGraph(gr.Graph):
	...
	def __init__(self, sourceV=None, destV=None, valueV=None, nv=None, element=0):
		"""
		if sourceV is None:
			if nv is not None: #create a DiGraph with an underlying pySpParMat* of the right size with no nonnulls
...
#				raise KeyError, 'at least one second index greater than #vertices'
	...
	def _reduce(self, dir, op, pred=None, noWrap=False):
		"""
		ToDo:  write doc
	...
	def _SpMV(self, other, semiRing=None, noWrap=False, inPlace=False):
		"""
		FIX:  add doc
