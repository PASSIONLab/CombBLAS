...
pySpParMatObj1::pySpParMatObj1(int64_t m, int64_t n, pyDenseParVec* rows, pyDenseParVec* cols, pyDenseParVecObj1* vals): A(NULL, commGrid)
{
...
public:
	...
	{
		fread(&row, sizeof(pySpParMatObj1::INDEXTYPE), 1,rFile);
		fread(&col, sizeof(pySpParMatObj1::INDEXTYPE), 1,rFile);
		fread(&val, sizeof(Obj1), 1,rFile);
		return;
	}
