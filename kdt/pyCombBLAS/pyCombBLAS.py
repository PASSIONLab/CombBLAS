...
class pySpParMatObj1(_object):
    ...
    def __getitem__(self, *args): return _pyCombBLAS.pySpParMatObj1___getitem__(self, *args)
    ...
    def ColWiseApply(self, *args): return _pyCombBLAS.pySpParMatObj1_ColWiseApply(self, *args)
    ...
    def Count(self, *args): return _pyCombBLAS.pySpParMatObj1_Count(self, *args)
...
class pySpParMatObj2(_object):
    ...
    def __getitem__(self, *args): return _pyCombBLAS.pySpParMatObj2___getitem__(self, *args)
    ...
    def ColWiseApply(self, *args): return _pyCombBLAS.pySpParMatObj2_ColWiseApply(self, *args)
    ...
    def Count(self, *args): return _pyCombBLAS.pySpParMatObj2_Count(self, *args)
...
class Obj1(_object):
    ...
    def __neq__(self, *args): return _pyCombBLAS.Obj1___neq__(self, *args)
    def __lt__(self, *args): return _pyCombBLAS.Obj1___lt__(self, *args)
    def __init__(self): 
        this = _pyCombBLAS.new_Obj1()
        try: self.this.append(this)
        except: self.this = this
...
class Obj2(_object):
    ...
    def __neq__(self, *args): return _pyCombBLAS.Obj2___neq__(self, *args)
    def __lt__(self, *args): return _pyCombBLAS.Obj2___lt__(self, *args)
    def __init__(self): 
        this = _pyCombBLAS.new_Obj2()
        try: self.this.append(this)
        except: self.this = this
