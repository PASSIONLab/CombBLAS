...
class pySpParVecObj(_object):
    ...
    def getnee(self): return _pyCombBLAS.pySpParVecObj_getnee(self)
    def __len__(self): return _pyCombBLAS.pySpParVecObj___len__(self)
    def len(self): return _pyCombBLAS.pySpParVecObj_len(self)
    def copy(self): return _pyCombBLAS.pySpParVecObj_copy(self)
    def any(self): return _pyCombBLAS.pySpParVecObj_any(self)
    def all(self): return _pyCombBLAS.pySpParVecObj_all(self)
    def intersectSize(self, *args): return _pyCombBLAS.pySpParVecObj_intersectSize(self, *args)
    def printall(self): return _pyCombBLAS.pySpParVecObj_printall(self)
    def load(self, *args): return _pyCombBLAS.pySpParVecObj_load(self, *args)
    def Count(self, *args): return _pyCombBLAS.pySpParVecObj_Count(self, *args)
    def Apply(self, *args): return _pyCombBLAS.pySpParVecObj_Apply(self, *args)
    def Sort(self): return _pyCombBLAS.pySpParVecObj_Sort(self)
    def setNumToInd(self): return _pyCombBLAS.pySpParVecObj_setNumToInd(self)
    def abs(self): return _pyCombBLAS.pySpParVecObj_abs(self)
    def __delitem__(self, *args): return _pyCombBLAS.pySpParVecObj___delitem__(self, *args)
    def __getitem__(self, *args): return _pyCombBLAS.pySpParVecObj___getitem__(self, *args)
    def __setitem__(self, *args): return _pyCombBLAS.pySpParVecObj___setitem__(self, *args)
    def __repr__(self): return _pyCombBLAS.pySpParVecObj___repr__(self)
...
class VERTEXTYPE(_object):
    ...
    def __repr__(self): return _pyCombBLAS.VERTEXTYPE___repr__(self)
    def __init__(self): 
        this = _pyCombBLAS.new_VERTEXTYPE()
        try: self.this.append(this)
        except: self.this = this
