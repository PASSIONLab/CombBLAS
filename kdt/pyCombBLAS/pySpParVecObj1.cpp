...
pySpParVecObj1::pySpParVecObj1(): v(commGrid)
{
}

pySpParVecObj1::pySpParVecObj1(int64_t size): v(commGrid, size)
{
}
...
#define VECCLASS pySpParVecObj1
//#define DENSE_VEC
#define NULL_PAR_TYPE   Obj1
