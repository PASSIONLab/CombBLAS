...
% KRONECKER_GENERATOR : Graph generator for Graph500 benchmark
%
% This has been modified to omit the random vertex permutation
%
...
% is removed by the final permutations.
  ...
  % [A,B,C] = deal(.6,.4/3,.4/3);  % These are Jeremy Kepner's RMAT numbers
