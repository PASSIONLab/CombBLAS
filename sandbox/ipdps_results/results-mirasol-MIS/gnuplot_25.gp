...
plot\
 ...
 "gnuplot_25.dat" every ::1 using 1:8:9:10 title '' ps 0 lc rgb '#008000' with errorbars,\
 "gnuplot_25.dat" every ::1 using 1:8 title 'SEJITS/SEJITS KDT' lc rgb '#008000' with lines
