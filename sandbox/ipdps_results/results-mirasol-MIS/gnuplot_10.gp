...
plot\
 ...
 "gnuplot_10.dat" every ::1 using 1:2 title 'PythonSR_PythonFilter_ER_OTF_22' with lines,\
 "gnuplot_10.dat" every ::1 using 1:5:6:7 title '' ps 0 lc rgb 'black' with errorbars,\
 "gnuplot_10.dat" every ::1 using 1:5 title 'PythonSR_SejitsFilter_ER_OTF_22' with lines,\
 "gnuplot_10.dat" every ::1 using 1:8:9:10 title '' ps 0 lc rgb 'black' with errorbars,\
 "gnuplot_10.dat" every ::1 using 1:8 title 'SejitsSR_SejitsFilter_ER_OTF_22' with lines
