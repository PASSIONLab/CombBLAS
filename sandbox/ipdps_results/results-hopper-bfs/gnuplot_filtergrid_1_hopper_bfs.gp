...
plot\
 ...
 "gnuplot_filtergrid_1_hopper_bfs.dat" every ::1 using 1:($12) title 'SEJITS/SEJITS KDT' lt 1 lw 7 lc rgb '#0000FF' pt 13 with linespoints,\
 "gnuplot_filtergrid_1_hopper_bfs.dat" every ::1 using 1:($17) title 'C++/C++ CombBLAS' lt 1 lw 7 lc rgb '#DAA520' pt 7 with linespoints
