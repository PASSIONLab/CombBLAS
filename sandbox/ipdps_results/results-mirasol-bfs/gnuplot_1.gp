...
plot\
 ...
 "gnuplot_1.dat" every ::1 using 1:11:12:13 title '' ps 0 lc rgb '#DAA520' with errorbars,\
 "gnuplot_1.dat" every ::1 using 1:11 title 'C++/C++ CombBLAS' lc rgb '#DAA520' with lines
