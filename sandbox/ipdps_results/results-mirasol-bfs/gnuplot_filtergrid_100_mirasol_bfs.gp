...
plot\
 ...
 "gnuplot_filtergrid_100_mirasol_bfs.dat" every ::1 using 1:($2) title 'Python/Python KDT' lc rgb '#FF0000' with lines,\
 "gnuplot_filtergrid_100_mirasol_bfs.dat" every ::1 using 1:10:8:9:11 title '' ps 0 lt 1 lc rgb '#8B0000' with candlesticks,\
 "gnuplot_filtergrid_100_mirasol_bfs.dat" every ::1 using 1:($7) title 'Python/SEJITS KDT' lc rgb '#8B0000' with lines,\
 "gnuplot_filtergrid_100_mirasol_bfs.dat" every ::1 using 1:15:13:14:16 title '' ps 0 lt 1 lc rgb '#0000FF' with candlesticks,\
 "gnuplot_filtergrid_100_mirasol_bfs.dat" every ::1 using 1:($12) title 'SEJITS/SEJITS KDT' lc rgb '#0000FF' with lines,\
 "gnuplot_filtergrid_100_mirasol_bfs.dat" every ::1 using 1:20:18:19:21 title '' ps 0 lt 1 lc rgb '#DAA520' with candlesticks,\
 "gnuplot_filtergrid_100_mirasol_bfs.dat" every ::1 using 1:($17) title 'C++/C++ CombBLAS' lc rgb '#DAA520' with lines
